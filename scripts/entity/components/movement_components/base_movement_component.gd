...
func on_movement_started(horizontal_vector2: Vector2) -> void:
	push_error('Abstract Method Not Implemented Error: %s' % [name])
	assert (false, 'Abstract Method Not Implemented Error: %s' % [name])

func on_movement(horizontal_vector2: Vector2) -> void:
	push_error('Abstract Method Not Implemented Error: %s' % [name])
	assert (false, 'Abstract Method Not Implemented Error: %s' % [name])

func on_movement_cancelled(horizontal_vector2: Vector2) -> void:
	push_error('Abstract Method Not Implemented Error: %s' % [name])
	assert (false, 'Abstract Method Not Implemented Error: %s' % [name])
